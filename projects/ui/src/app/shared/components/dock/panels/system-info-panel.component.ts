...
/**
 * System info panel showing OS, CPU, Memory, Storage, GPU, and Network info.
...
@Component({
  ...
  template: `
    <div class="system-info-panel p-3 space-y-4 text-xs h-full overflow-y-auto">
      <!-- Windows Version -->
      @if (osInfo()) {
...
export class SystemInfoPanelComponent implements OnInit, OnDestroy {
